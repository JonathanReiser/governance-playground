# Adversarial-review handoff: conformity hardening

Branch: `prototype/verifiable-execution-v0`

Starting commit: `4c5622f46ae76bcb8aff0294c8979eaddf0937f3`.

Input used: the user's supplied finding IDs and detailed remediation request. The
attachment contained that request; no separate Claude audit document was present.
No merge to main. No changes to scientific preregistration code/archives or its tests.
...
Final tests on Node.js 24.19.0, macOS:
