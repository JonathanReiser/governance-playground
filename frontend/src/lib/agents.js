...
export function generateClientQAIDecision(scenarioId, nation, worldState) {
  ...
  return {
    ...
    supportingActions: [],
    reasoning: "Decision computed via Q-AI Client Engine.",
    metricDeltas: { stability: 1, publicSentiment: 1 },
    researchNote: "Q-AI Client Engine."
  };
}
...
export class NationAgent {
  ...
  async decide(worldState, scenarioId, decideFn) {
    ...
    return {
      ...
      decision,
      model: "q-ai-client-engine",
      usage: { input_tokens: 0, output_tokens: 0 },
      newsSource: "mock-fallback (Q-AI Client Engine)"
    };
  }
